export const clients = [
  { name: client1, id: "1", alt: "client1" },
  { name: client2, id: "2", alt: "client2" },
  { name: client3, id: "3", alt: "client3" },
  { name: client4, id: "4", alt: "client4" },
  { name: client5, id: "5", alt: "client5" },
  { name: client6, id: "6", alt: "client6" },
  { name: client7, id: "7", alt: "client7" },
  { name: client8, id: "8", alt: "client8" },
];
